...
int main() {
    // Example AES key (128 bits / 16 bytes)
    //unsigned char key[16] = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x97, 0x75, 0x46, 0x20, 0x63, 0xed};

    unsigned char key[16] = "abcdefghijkabcde";
    // Print key
    printf("Key: ");
    for (int i = 0; i < 16; i++) {
        printf("%c", key[i]);
    ...
    // Example plaintext (128 bits / 16 bytes)
    unsigned char plaintext[16] = "HelloIamAESEncry";
    ...
    // Expanded key for encryption and decryption
